...
public class SearchService {
    ...
    private List<Map<String, Object>> getParamAggResult(Long cid, QueryBuilder basicQuery) {
        ...
        // 查询要聚合的规格参数
        List<SpecParam> params = this.specificationClent.queryParams(null, cid, null, true);
    ...
    public Goods buildGoods(Spu spu) throws IOException {
        ...
        List<SpecParam> params = this.specificationClent.queryParams(null, spu.getCid3(), null, true);
